...
class GAT(torch.nn.Module):
    ...
    def fit(self, feat, adj, labels, idx, data=None, train_iters=600, initialize=True, verbose=False, patience=None, noval=False, **kwargs):
        ...
        data_train.y = data_train.y.float().to('cuda') if self.multi_label else data_train.y.to('cuda')
        ...
        for i in range(train_iters):
            ...
            with torch.no_grad():
                ...
                #if self.dataset != 'cora' and self.dataset != 'ogbn-arxiv':
                if self.dataset == 'citeseer':
                    print('LOSS best ecpoh ',i)
