...
class GCN(nn.Module):
    ...
    def _train_with_val(self, labels, data, train_iters, verbose, adj_val=False):
        ...
        adj_full_norm = utils.normalize_adj_tensor(adj_full, sparse=True) # adj_full
        print(adj_full.shape,adj_full_norm.shape,'haha')
        ...
        for i in range(train_iters):
            ...
            #print(output.shape,labels.shape,' haha')
            ...
            with torch.no_grad():
                ...
                if acc_val > best_acc_val:
                    ...
                    print('Getting best_val on iter: ',i)
